...
export const metadata: Metadata = {
  ...
  description:
    "How CasaMinder collects, uses and protects personal data for website enquiries and property care services.",
};
...
const policySections = [
  ...
  },
  {
    ...
    closing: "We do not use your personal data for unrelated purposes.",
  },
  {
    heading: "5. Lawful bases for processing under GDPR",
    content: [
  ...
  {
    heading: "6. Email, contact form and WhatsApp enquiries",
    content: [
  ...
  {
    heading: "7. Sharing personal data with third parties",
    content: [
  ...
  {
    heading: "9. How long we keep personal data",
    content: [
  ...
  {
    heading: "12. Your rights under GDPR",
    content: [
  ...
  {
    heading: "13. How to contact us about privacy requests",
    content: [
  ...
  {
    heading: "14. Complaints to a supervisory authority",
    content: [
  ...
  return (
    <main className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-3xl bg-white p-8 shadow-card sm:p-10">
        ...
        <h1 className="font-serif text-4xl font-semibold text-charcoal sm:text-5xl">Privacy Policy</h1>

        <div className="mt-8 space-y-6 text-muted leading-8">
          <p>
            This Privacy Policy explains how CasaMinder collects, uses and protects personal data when you visit our
            website, contact us, or use our property care services.
          </p>
          <p>
            CasaMinder provides property care, keyholding, property checks, housekeeping coordination, maintenance
            coordination, owner support and pre-arrival preparation in Lisbon, Setubal and surrounding areas in
            Portugal.
          </p>
          <p>We aim to keep this policy clear and easy to understand. We do not sell your personal data.</p>
